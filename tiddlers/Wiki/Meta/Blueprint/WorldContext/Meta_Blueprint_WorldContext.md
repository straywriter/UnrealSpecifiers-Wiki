...
- **引擎模块：** Blueprint
- **元数据类型：** string="abc"
- **关联项：** [CallableWithoutWorldContext](#Meta_Blueprint_CallableWithoutWorldContext), [ShowWorldContextPin](#Meta_Blueprint_ShowWorldContextPin)
- **常用程度：** ★★★★★
...
![Untitled](Meta_Blueprint_WorldContext_Untitled_2.png)
