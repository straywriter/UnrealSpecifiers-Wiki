...
- **引擎模块：** Blueprint
- **元数据类型：** bool
- **关联项：** [BlueprintPrivate](#Meta_Blueprint_BlueprintPrivate), [AllowPrivateAccess](#Meta_Blueprint_AllowPrivateAccess)
- **常用程度：** ★★★
...
![Untitled](Meta_Blueprint_BlueprintProtected_Untitled.png)

蓝图中的子类（BPA_Access_Child继承自BPA_Access_Base）效果：

可见MyNative函数的访问一样。而MyBPPrivate则不能被调用了，这和我们预想的规则一样。

![Untitled](Meta_Blueprint_BlueprintProtected_Untitled_1.png)
...
![Untitled](Meta_Blueprint_BlueprintProtected_Untitled_2.png)
...
![Untitled](Meta_Blueprint_BlueprintProtected_Untitled_3.png)
...
![Untitled](Meta_Blueprint_BlueprintProtected_Untitled_4.png)
...
![Untitled](Meta_Blueprint_BlueprintProtected_Untitled_5.png)
