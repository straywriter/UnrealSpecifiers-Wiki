...
- **限制类型：** UObject*
- **关联项：** [DisallowedAssetDataTags](#Meta_Asset_DisallowedAssetDataTags), [AssetRegistrySearchable](#Specifier_UPROPERTY_Asset_AssetRegistrySearchable)
- **常用程度：** ★★
...
![Untitled](Meta_Asset_RequiredAssetDataTags_Untitled.png)
