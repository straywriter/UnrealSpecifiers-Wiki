...
- **作用机制：** 在PropertyFlags中加入[CPF_BlueprintCallable](#Flags_EPropertyFlags_CPF_BlueprintCallable)
- **常用程度：** ★★★
...
![Untitled](Specifier_UPROPERTY_Blueprint_BlueprintCallable_Untitled.png)
