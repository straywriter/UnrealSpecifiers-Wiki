...
- **元数据类型：** bool
- **引擎模块：** Serialization
- **作用机制：** 在PropertyFlags中加入[CPF_Transient](#Flags_EPropertyFlags_CPF_Transient)
- **常用程度：★★★★★**
...
![Untitled](Specifier_UPROPERTY_Serialization_Transient_Untitled.png)
...
![Untitled](Specifier_UPROPERTY_Serialization_Transient_Untitled_1.png)