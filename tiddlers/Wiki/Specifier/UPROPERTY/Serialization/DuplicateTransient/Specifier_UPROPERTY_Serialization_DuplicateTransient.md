...
- **元数据类型：** bool
- **引擎模块：** Serialization
- **作用机制：** 在PropertyFlags中加入[CPF_DuplicateTransient](#Flags_EPropertyFlags_CPF_DuplicateTransient)
- **常用程度：** ★★
...
![Untitled](Specifier_UPROPERTY_Serialization_DuplicateTransient_Untitled.png)
