...
- **引擎模块：** Category
- **元数据类型：** bool
- **作用机制：** 在Meta中增加[IgnoreCategoryKeywordsInSubclasses](#Meta_DetailsPanel_IgnoreCategoryKeywordsInSubclasses)
- **常用程度：★★**
...
![Untitled](Specifier_UCLASS_Category_ComponentWrapperClass_Untitled.png)
