...
- **引擎模块：** Development
- **元数据类型：** bool
- **作用机制：** 在ClassFlags添加[CLASS_Deprecated](#Flags_EClassFlags_CLASS_Deprecated)、[CLASS_NotPlaceable](#Flags_EClassFlags_CLASS_NotPlaceable)，在Meta添加[DeprecationMessage](#Meta_Development_DeprecationMessage)、[DeprecatedProperty](#Meta_Development_DeprecatedProperty)
- **常用程度：★★★**
...
![Untitled](Specifier_UCLASS_Development_Deprecated_Untitled.png)
...
![Untitled](Specifier_UCLASS_Development_Deprecated_Untitled_1.png)
