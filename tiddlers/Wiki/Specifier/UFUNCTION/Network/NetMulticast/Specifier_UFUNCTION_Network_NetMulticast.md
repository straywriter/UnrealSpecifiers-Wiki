...
- **元数据类型：** bool
- **引擎模块：** Network
- **作用机制：** 在FunctionFlags中加入[FUNC_Net](#Flags_EFunctionFlags_FUNC_Net)、[FUNC_NetMulticast](#Flags_EFunctionFlags_FUNC_NetMulticast)
- **常用程度：★★★★★**
...
![Untitled](Specifier_UFUNCTION_Network_NetMulticast_Untitled.png)
