...
- **作用机制：** 在PropertyFlags中加入[CPF_ConstParm](#Flags_EPropertyFlags_CPF_ConstParm)，在Meta中加入[NativeConst](#Meta_Blueprint_NativeConst)
- **常用程度：** ★
...
![Untitled](Specifier_UPARAM_Blueprint_Const_Untitled.png)
